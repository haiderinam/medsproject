...
Therefore, during simulations, Positive Control 1 will be downsampled from `r sum(alldata_comp$Positive_Ctrl1) ` to `r maxsubsamplesize` and Positive Control 2 will be downsampled from `r sum(alldata_comp$Positive_Ctrl2) ` to `r maxsubsamplesize`  
